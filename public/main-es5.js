...
var EmployeeComponent = /** @class */ (function () {
    function EmployeeComponent(employeeService, router, positionService) {
    ...
    EmployeeComponent.prototype.ngOnInit = function () {
        ...
        var _this = this;
        this.paramSubscription = this.router.params.subscribe(function (params) {
            // console.log(params.id);
            _this.employeeSubscription = _this.employeeService.getEmployee(params.id).subscribe(function (emp) {
                _this.employee = emp[0];
                _this.getPositionsSubcription = _this.positionService.getPositions().subscribe(function (data) {
...
var EmployeesComponent = /** @class */ (function () {
    ...
    EmployeesComponent.prototype.onEmployeeSearchKeyUP = function (event) {
        ...
        this.filteredEmployees = this.employees.filter(function (employee) {
            return ((employee.FirstName.toLowerCase().indexOf(string) !== -1) ||
...
var PositionComponent = /** @class */ (function () {
    ...
    PositionComponent.prototype.ngOnInit = function () {
        ...
        this.paramSubscription = this.activatedRoute.params.subscribe(function (params) {
            _this.positionSubscription = _this.positionService.getPosition(params.id).subscribe(function (postn) {
                _this.position = postn[0];
            });
        });
    };
...
var PositionsComponent = /** @class */ (function () {
    function PositionsComponent(pos, router) {
        this.pos = pos;
        this.router = router;
        this.loadingError = false;
    }
    PositionsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getPositionsSub = this.pos.getPositions().subscribe(function (positions) { return _this.positions = positions; }, function (e) {
            this.loadingError = true;
        });
    };
